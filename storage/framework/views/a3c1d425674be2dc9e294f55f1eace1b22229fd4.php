        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" action="<?php echo e(route('dashboard.designation.store')); ?>" id="add_designation_form" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="office_id" value="<?php echo e(Auth()->user()->office_id); ?>">
                            <div class="col-md-12">
    ...
    <script>
        $(document).ready( function() {
            ...
            var designation__table = $('.data_tbl').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('dashboard.designation.index')); ?>",
                },
                columns: [
...
<?php echo $__env->make('dashboard.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sugar_mill_project\resources\views/dashboard/designation/index.blade.php ENDPATH**/ ?>