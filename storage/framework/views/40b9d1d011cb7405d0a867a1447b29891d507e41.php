...
<div class="container">
    ...
    <div class="col-md-6" style="<?php echo \Illuminate\Support\Arr::toCssStyles(['text-align: right']) ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" action="<?php echo e(route('dashboard.user.store')); ?>" id="add_user_form" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="first_name" id="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="First Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="last_name" id="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Last Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" placeholder="Office Phone">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="E-mail">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="address" id="address" value="<?php echo e(old('address')); ?>" placeholder="Office Address">
    ...
    <script>
        $(document).ready( function() {
            ...
            var user__table = $('.data_tbl').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('dashboard.user.index')); ?>",
                },
                columns: [
...
<?php echo $__env->make('dashboard.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sugar_mill_project\resources\views/dashboard/user/index.blade.php ENDPATH**/ ?>