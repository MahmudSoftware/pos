...
<div class="container">
    ...
    <div class="col-md-6" @style(['text-align: right'])>
        <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">Add Group</button>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLargeModalLabel">Add User Group</h4>
                </div>
                <div class="modal-body">
                    <form class="" action="{{ route('route.group.store') }}" id="add_user_form" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="group_name" id="group_name" value="" placeholder="Group Name">
