    ...
    <div class="container">
        ...
        <div class="col-md-6" @style(['text-align: right'])>
            <button class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                data-target=".bs-example-modal-lg">Add User Role</button>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    @foreach ($role->permissions as $rpermission)
                                                        <span class="badge badge-secondary">{{ $rpermission->name }}</span>
                                                    @endforeach
                                                </th>
                                                <th>
                                                    <div class="btn-group"><button type="button"
                                                            class="btn btn-primary dropdown-toggle waves-effect waves-light  waves-effect"
                                                            data-toggle="dropdown" aria-expanded="false"> Action <span
                                                                class="caret"></span> </button>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="" id="delete_btn">Delete</a></li>
                                                            <li><a href="{{ route('user.role.edit',$role->id) }}" id="edit_btn">Edit</a></li>
                                                        </ul>
                                                    </div>
                                                </th>
                                            </tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" action="{{ route('user.role.store') }}" id="add_role_form" method="POST">
                            @csrf
                            @method('POST')
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required="" placeholder="Role Name"
                                                    ...
                                                    <div class="panel-body">
                                                        @foreach ($permissions as $permissionData)
                                                            ...
                                                            <div class="checkbox checkbox-circle">
                                                                <input id="checkbox{{ $permissionData->name }}" name="permissions[]" type="checkbox"
