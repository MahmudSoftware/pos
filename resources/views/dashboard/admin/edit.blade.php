                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user_type">
                                ...
                                <option value="3" {{ $user->user_type == 3 ? 'SELECTED':'' }}>Operator</option>
                                <option value="4" {{ $user->user_type == 4 ? 'SELECTED':'' }}>MIS</option>
                                <option value="5" {{ $user->user_type == 5 ? 'SELECTED':'' }}>Mill Supervisor</option>
                            </select>
